---
name: qa-functional
description: Functional QA specialist. Tests core features, forms, CRUD, navigation, search/filter/sort, uploads and persistence against the running app. Used by the /qa skill.
